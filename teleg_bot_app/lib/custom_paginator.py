...
class CustomPaginator(Paginator):
    def __init__(self, object_list, per_page, pagination_pages_range, orphans=0,
        ...
        self.pagination_pages_range = pagination_pages_range  #количество страниц справа и слева от текущей
        self.pagination_pages_totally = pagination_pages_range * 2 + 1  #суммарное видимое количество страниц в пагинаторе
